...
export function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    // ✅ FIX 3: parameterized query — criteria never interpolated into SQL
    // ❌ Before: template literal → attacker could send ' UNION SELECT * FROM Users--
    //           to dump entire Users table including emails and password hashes
